...
async def main():
    ...
    options = ClaudeAgentOptions(
        system_prompt={
            ...
            "preset": "claude_code",
            "append": (
                "\n\n## 🚨 MANDATORY FILE EDITING RULES\n"
                "These rules override all other instructions:\n\n"
                "1. **DashboardOverview.tsx** — You may Write this file ONCE (the initial creation). "
                "After that, you MUST use the Edit tool for ANY changes. "
                "NEVER use Write to replace the entire file after the first creation.\n\n"
                "2. **index.css** — NEVER use Write on this file. It is pre-generated. "
                "ONLY use the Edit tool to extend or modify it (e.g. adding design tokens to :root).\n\n"
                "3. **Layout.tsx** — NEVER use Write on this file. It is pre-generated. "
                "ONLY use the Edit tool for small targeted changes (e.g. APP_TITLE, APP_SUBTITLE).\n\n"
                "4. **CRUD pages and dialogs** — NEVER use Write or Edit on scaffold-generated files "
                "(e.g. *Page.tsx, *Dialog.tsx, ConfirmDialog.tsx, StatCard.tsx, PageShell.tsx). They are complete.\n\n"
                "5. **After writing/editing ANY file, do NOT Read it back.** Move to the next file. "
                "If a fix is needed later, use Edit with a small targeted old_string/new_string.\n\n"
                "6. **Do NOT Read files that were provided in tool responses.** "
                "The generate_typescript tool includes full contents of index.css, Layout.tsx, App.tsx, "
                "DashboardOverview.tsx, types, and service — use those directly.\n"
            )
        },
